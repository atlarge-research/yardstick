...
- **SSH** -- Uses the `ssh2` library to open persistent SSH sessions to remote hosts (DAS-5, DAS-6, or any custom host). Supports password and private-key auth, and optional jump-host tunneling (ProxyJump) for off-campus access.
