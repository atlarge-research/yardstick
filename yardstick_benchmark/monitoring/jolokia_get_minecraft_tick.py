...
if __name__ == "__main__":
    print(
        "measurement,tick_duration_ms,tick_number,loop_iteration,timestamp_ms,computed_timestamp_ms"
    )
    ...
    while True:
        ...
        with request.urlopen(r) as resp:
            ...
            for tick_duration in tick_times:
                ...
                print(
                    f"minecraft_tick_duration,{tick_duration / 1000000},{tick_number},{loop_iteration},{now * 1000},{computed_timestamp}"
                )
                tick_number += 1
